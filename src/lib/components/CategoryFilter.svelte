...
<div class="flex flex-wrap gap-3">
	{#if showAll}
		<button
			...
			class="px-4 py-2 rounded-full text-sm font-medium transition-all duration-200 focus:outline-none focus-visible:outline-none active:outline-none {selectedCategory ===
			null
